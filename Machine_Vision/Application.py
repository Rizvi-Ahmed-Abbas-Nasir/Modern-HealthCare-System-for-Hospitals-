...
import final_pred
import FaceDetectionPrediction
...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        ImageHome5 = customtkinter.CTkImage(dark_image=PIL.Image.open("Assets\doctor.jpg"), size=(350, 240))
        ...
        self.Pages.add(" Doctor Equipment Tracker ")
    ...
    ### Word
        ...
        # Hand Sign
        # Label Presentation Controller
        self.WordHomeLabel___0 = customtkinter.CTkLabel(self.Pages.tab(" Doctor Equipment Tracker "),
                                                    text=" Doctor Equipment Tracker ",
                                                    font=customtkinter.CTkFont(family="IBM Plex Sans", size=27),
                                                    corner_radius=0)
        self.WordHomeLabel___0.place(x=20, y=5)

        # Image Presentation Controller
        self.WordHomeLabel___1 = customtkinter.CTkLabel(self.Pages.tab(" Doctor Equipment Tracker "),
                                                    text=" ",
                                                    image=ImageHome5,
                                                    font=customtkinter.CTkFont(family="IBM Plex Sans", size=25),
                                                    corner_radius=0)
        ...
        # Desktop Presentation Controller
        self.WordButton____0 = customtkinter.CTkButton(self.Pages.tab(" Doctor Equipment Tracker "),
                                                       corner_radius=100,
                                                       text="Start",
        ...
        # TextBox Presentation Controller
        self.WordTextbox_0 = customtkinter.CTkTextbox(self.Pages.tab(" Doctor Equipment Tracker "), width=350, height=240)
        self.WordTextbox_0 = customtkinter.CTkTextbox(self.Pages.tab(" Doctor Equipment Tracker "), width=350, height=240)
    ...
    def open_HandSignWordDectectionApplication(self):
        g = FaceDetectionPrediction.main()
        t = threading.Thread(target=g.start)
        t.start()
